...
import 'package:shapeyou/widgets/cart/counter_widget.dart';
...
class _AddToCartWidgetState extends State<AddToCartWidget> {
  ...
  @override
  void initState() {
    getCartData(); //while opening product details screen, first will check this item
...
//if no cart item exists, we need to delete entire cart data of that user
