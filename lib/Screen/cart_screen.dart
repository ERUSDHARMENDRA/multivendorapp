...
import 'package:shapeyou/services/cart_services.dart';
import 'package:shapeyou/services/order_services.dart';
import 'package:shapeyou/services/store_services.dart';
import 'package:shapeyou/services/user_services.dart';
import 'package:shapeyou/widgets/cart/cart_list.dart';
import 'package:shapeyou/widgets/cart/cod_toggle.dart';
import 'package:shapeyou/widgets/cart/coupon_widget.dart';
                              ...
                              onPressed: () {
                                ...
                                _userService
                                  ...
                                  if (value.data()['firstName'] == null) {
                                    ...
                                    EasyLoading.dismiss();
                                    //EasyLoading.show(status: 'Please wait...');
                                    //first check payment type. cod or not.
                                    if (_cartProvider.cod == false) {
                                      ...
                                      Navigator.pushNamed(
                                          ...
                                          .whenComplete(() {
                                        //need to put StripeHome.id in place of SplashScreen.id
